...
452 tests and eight fuzz targets, all green and clean under `-race`, run on every push by CI.
...
Roughly 11,983 lines of implementation and 16,144 of tests, across 452 tests. The ratio is not an accident.
