...
463 tests and eight fuzz targets, all green and clean under `-race`, run on every push by CI.
...
Roughly 12,036 lines of implementation and 16,482 of tests, across 463 tests. The ratio is not an accident.
