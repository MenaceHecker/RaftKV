...
461 tests and eight fuzz targets, all green and clean under `-race`, run on every push by CI.
...
Roughly 11,996 lines of implementation and 16,377 of tests, across 461 tests. The ratio is not an accident.
