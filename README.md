...
503 tests and eight fuzz targets, all green and clean under `-race`, run on every push by CI.
...
Roughly 12,250 lines of implementation and 17,021 of tests, across 503 tests. The ratio is not an accident.
