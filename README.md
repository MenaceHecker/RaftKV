...
448 tests and eight fuzz targets, all green and clean under `-race`, run on every push by CI.
...
Roughly 11,966 lines of implementation and 16,065 of tests, across 448 tests. The ratio is not an accident.
