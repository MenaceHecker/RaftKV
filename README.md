...
526 tests and eight fuzz targets, all green and clean under `-race`, run on every push by CI.
...
Roughly 12,500 lines of implementation and 19,000 of tests, across 526 tests. The ratio is not an accident.
